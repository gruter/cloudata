 ...
 * string.
 */
public class CText implements CWritableComparable, WritableComparable {
  private static final Log LOG = LogFactory.getLog(CText.class.getName());
   ...
   */
  public CText(String string) {
    set(string);
  }

  /** Construct from another text. */
  public CText(CText utf8) {
    set(utf8);
  }

  /** Construct from a byte array.
   */
  public CText(byte[] utf8)  {
    set(utf8);
  }
  ...
  public int compareTo(Object o) {
    ...
    if (this == that)
      ...
      return CWritableComparator.compareBytes(bytes, 0, length,
  ...
  public static class Comparator extends CWritableComparator {
    ...
    public int compare(byte[] b1, int s1, int l1,
      ...
      try {
        ...
        return compareBytes(b1, s1+CWritableUtils.getVIntSize(n1), n1, 
                            b2, s2+CWritableUtils.getVIntSize(n2), n2);
      }catch(IOException e) {
        LOG.warn(e);
  ...
  static {
    ...
    CWritableComparator.define(CText.class, new Comparator());
  }
