 ...
 *
 */
public class DataCellResource extends Resource {
  private static final Log LOG = LogFactory.getLog(DataCellResource.class.getName());
	...
	public DataCellResource(Context context, Request request, Response response) {
		...
		cellKey = (String) getRequest().getAttributes().get("cell_key");
	}
